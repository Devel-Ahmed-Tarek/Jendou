...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/public/backend/assets/plugins/sweetalert2/sweetalert2.min.css')); ?>">
    <!-- ======= END BEGIN PAGE LEVEL PLUGINS STYLES ======= -->

    <!-- Dropzone-->
    <link rel="stylesheet" href="<?php echo e(asset('/public/backend/assets/plugins/dropzone/dropzone.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('/public/backend/assets/plugins/daterangepicker/daterangepicker.css')); ?>">

    <?php echo $__env->yieldContent('custom_css'); ?>
    <!-- ======= MAIN STYLES ======= -->
    <link rel="stylesheet" href="<?php echo e(asset('/public/backend/assets/css')); ?>/<?php echo e($style_path); ?>/style.css">
    <link rel="stylesheet" href="<?php echo e(asset('/public/backend/assets/css/custom.css')); ?>">
    <!-- ======= END MAIN STYLES ======= -->
    <style>
...
<?php /**PATH /var/www/tl-commerce-saas/tlcommercesaas/Core/Views/base/layouts/head.blade.php ENDPATH**/ ?>