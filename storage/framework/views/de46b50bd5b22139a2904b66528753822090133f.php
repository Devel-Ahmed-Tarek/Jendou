...
<?php $__env->startSection('title'); ?>
    <?php echo e(translate('Theme Options')); ?>
...
<?php $__env->startSection('custom_css'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/themes/tlcommerce/public/blog/css/font-awesome.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('/themes/tlcommerce/public/blog/dist/css/fontawesome-iconpicker.min.css')); ?>">
...
<?php $__env->startSection('main_content'); ?>
    ...
    <div class="theme-option-container">
        <form action="<?php echo e(route('theme.tlcommerce.save.option.form')); ?>" method="post" enctype="multipart/form-data"
            id="themeOptionForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="theme-option-sticky d-flex align-items-center justify-content-between bg-white border-bottom2 p-3">
                <div class="theme-option-logo d-none d-sm-block">
                    <h3><?php echo e(translate('Theme Options')); ?></h3>
                </div>
                <div class="theme-option-action_bar">
                    <input type="submit" class="btn btn-primary sm tn btn-primary sm button-save-theme-options"
                        name="save_changes" value="<?php echo e(translate('Save Changes')); ?>">
                    <input type="submit" class="btn btn-info sm" name="reset_section"
                        value="<?php echo e(translate('Reset Section')); ?>">
                    <input type="submit" class="btn btn-info sm" name="reset_all" value="<?php echo e(translate('Reset All')); ?>">
                </div>
            </div>

            <div class="theme-option-tab-wrap">
                <div class="nav flex-column py-3 px-2 theme-option-sidebar" aria-orientation="vertical">
                    <?php if ($__env->exists('theme/tlcommerce::backend.theme.option_sidebar')) echo $__env->make('theme/tlcommerce::backend.theme.option_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>

                <div class="form border-left2">
                    <div id="loader" class="d-none">
                        <img src="<?php echo e(asset('/public/loader.svg')); ?>" alt="" width="80px" height="auto">
                    </div>
                    <div class="card">
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title h6"><?php echo e(translate('Reset Confirmation')); ?></h4>
                </div>
                <div class="modal-body text-center">
                    <p class="mt-1"><?php echo e(translate('Are you sure to want to reset')); ?>?</p>
                    <button class="btn long mt-2 btn-danger" data-dismiss="modal"><?php echo e(translate('Cancel')); ?></button>
...
<?php $__env->startSection('custom_scripts'); ?>
    ...
    <script src="<?php echo e(asset('/themes/tlcommerce/public/blog/dist/js/fontawesome-iconpicker.min.js')); ?>"></script>
    ...
    <script  type="application/javascript">
        ...
        function getOptionForm(id){
            ...
            $.ajax({
                type: "post",
                url: '<?php echo e(route('theme.tlcommerce.get.option.form')); ?>',
                data: {
                    id: id
                },
                ...
                error: function(data, textStatus, jqXHR) {
                    toastr.error('<?php echo e(translate('Action Failed')); ?>', 'ERROR!!');
                }
            });
        }
        //Init summernote
        ...
        function addedToSubsets(subsetId ,subsets)
        {
            ...
            $(subsetId).html('');
            $(subsetId).append(`<option value="" selected><?php echo e(translate('Select Font Subsets')); ?></option>`);
        ...
        function addedToFontWeight(fontWeigthId ,variations)
        {
            ...
            $(fontWeigthId).html('');
            $(fontWeigthId).append(`<option value="" selected><?php echo e(translate('Select Weight & Style')); ?></option>`);
...
<?php echo $__env->make('core::base.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tl-commerce-saas/tlcommercesaas/themes/tlcommerce/resources/views/backend/theme/options.blade.php ENDPATH**/ ?>