...
<script src="<?php echo e(asset('/public/backend/assets/plugins/moment/moment.min.js')); ?>"></script>
<script src="<?php echo e(asset('/public/backend/assets/plugins/dropzone/dropzone.min.js')); ?>"></script>
<!-- ======= BEGIN GLOBAL MANDATORY SCRIPTS ======= -->
...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            ...
            function getNotification() {
                $.ajax({
                    ...
                    type: "Get",
                    url: '<?php echo e(route('core.admin.notification.list')); ?>',
                    success: function(response) {
                        if (response.success) {
                            ...
                            if (total_notification > 0) {
                                ...
                                $(".notification-list-items").html(
                                    '<?php echo e(translate('You have no unread notification')); ?>');
        ...
        $('#lang-change .dropdown-item').each(function() {
            $(this).on('click', function(e) {
                ...
                $.post('<?php echo e(route('core.language.change')); ?>', {
        ...
        $(document).on("click", ".single-notification-item", function(e) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: '<?php echo e(route('core.admin.notification.mark.as.read.single')); ?>',
                data: {
                    id: id
                },
                success: function(response) {
        ...
        $(".mark-as-all-read").on("click", function(e) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: '<?php echo e(route('core.admin.notification.mark.as.read.all')); ?>',
                success: function(response) {
                    if (response.success) {
        ...
        $('.darklooks-mode-changer').on('click', function(e) {
            e.preventDefault();
            $.post('<?php echo e(route('core.mood.change')); ?>', {
                _token: '<?php echo e(csrf_token()); ?>'
            }, function(data) {
                location.reload();
            })
    ...
    function initDropzone() {
        "use strict";
        let total_files = 0
        let chunk_size = parseInt("<?php echo e($chink_size); ?>")
        Dropzone.autoDiscover = false;
        $("#uploaded").dropzone({
            url: '<?php echo e(route('core.upload.media.file')); ?>',
            parallelUploads: 9,
            uploadMultiple: true,
            maxFilesize: 256,
            timeout: 3600000,
    ...
    function mediaFilterApi() {
        ...
        return new Promise((resolve, reject) => {
            $.post("<?php echo e(route('core.filter.media.list')); ?>", param)
                .done((data) => {
                    let view = data.view;
    ...
    function updateMedia() {
        ...
        $.post("<?php echo e(route('core.update.media.file.info')); ?>", {
                _token: '<?php echo e(csrf_token()); ?>',
                media_id: media_id,
                alt: alt,
                title: title,
    ...
    function nextMediaSlide(e, media_id, id) {
        ...
        $.post("<?php echo e(route('core.get.media.details.by.id')); ?>", {
                _token: '<?php echo e(csrf_token()); ?>',
    ...
    function deleteMediaFile() {
        "use strict";
        $.post("<?php echo e(route('core.delete.media.file')); ?>", {
                _token: '<?php echo e(csrf_token()); ?>',
                id: selected_file_id
            },
            function(data, status) {
        ...
        for (let i = 0; i < selected_file_id.length; i++) {
            ...
            if (splitted_file_extension == 'mp4') {
                $(insertableIds[0]).attr('src',
                    '<?php echo e(project_asset('/backend/assets/img/mp4-placeholder.png')); ?>');
            } else if (splitted_file_extension == 'zip') {
                $(insertableIds[0]).attr('src',
                    '<?php echo e(project_asset('/backend/assets/img/zip-placeholder.png')); ?>');
            } else if (splitted_file_extension == 'pdf') {
                $(insertableIds[0]).attr('src',
                    '<?php echo e(project_asset('/backend/assets/img/pdf-placeholder.png')); ?>');
            } else {
    ...
    function removeSelection(ids) {
        ...
        $(rmoveableIds[0]).attr('src', '<?php echo e(project_asset($placeholder_image)); ?>')
        $(rmoveableIds[1]).val('')
        $(rmoveableIds[2]).hide()
    }
...
<?php echo $__env->yieldContent('partial_scripts'); ?>
<?php echo $__env->yieldPushContent('script'); ?>
<script src="<?php echo e(asset('/public/backend/assets/js/script.js')); ?>"></script>
<?php /**PATH /var/www/tl-commerce-saas/tlcommercesaas/Core/Views/base/layouts/script.blade.php ENDPATH**/ ?>