...
<form action="#" class=" widget_input_field_form px-3 py-3 bg-white"
    ...
    <div class="form-group <?php if(!empty($lang) && $lang != getdefaultlang()): ?> area-disabled <?php endif; ?>">
        ...
        <select class="form-control" name="menu_group_id" id="menu_group_id" <?php if(!empty($lang) && $lang != getdefaultlang()): ?> disabled <?php endif; ?>>
...
<?php /**PATH /var/www/tl-commerce-saas/tlcommercesaas/themes/tlcommerce/resources/views/backend/widgets/widget-forms/footer_right_menu.blade.php ENDPATH**/ ?>