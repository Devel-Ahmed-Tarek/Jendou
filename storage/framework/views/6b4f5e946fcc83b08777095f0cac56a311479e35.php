        ...
        <div class="container position-relative">
            <div class="row d-flex align-items-center logo-area">
                <div class="col-lg-3 col-md-4 col-6">
                    <!-- Logo -->
                    <div class="logo">
                        <a href="<?php echo e(route('theme.default.home')); ?>">
                            <?php if($mood === 'dark'): ?>
                            <!-- Main Header Logo -->
                            <?php if(isset($dark_header_logo)): ?>
                            <img src="<?php echo e(project_asset($dark_header_logo)); ?>" alt="Logo" class="img-fluid default-logo">
                            <?php elseif(isset($text_logo)): ?>
                            <h2 class="default-logo"> <?php echo e($text_logo); ?></h2>
                            <?php endif; ?>
                            <!-- Main Header Mobile Logo -->
                            <?php if(isset($dark_mobile_logo)): ?>
                            <img src="<?php echo e(project_asset($dark_mobile_logo)); ?>" alt="Logo" class="img-fluid mobile-logo">
                            <?php elseif(isset($text_logo)): ?>
                            <h2 class="mobile-logo"> <?php echo e($text_logo); ?> </h2>
                            <?php endif; ?>

                            <!-- Sticky Header Logo -->
                            <?php if(isset($dark_sticky_header_logo)): ?>
                            <img src="<?php echo e(project_asset($dark_sticky_header_logo)); ?>" alt="Logo" class="img-fluid sticky-logo">
                            <?php elseif(isset($text_logo)): ?>
                            <h2 class="sticky-logo"> <?php echo e($text_logo); ?> </h2>
                            <?php endif; ?>
                            <!-- Sticky Header Mobile Logo -->
                            <?php if(isset($dark_mobile_sticky_header_logo)): ?>
                            <img src="<?php echo e(project_asset($dark_mobile_sticky_header_logo)); ?>" alt="Logo" class="img-fluid sticky-mobile-logo">
                            <?php elseif(isset($text_logo)): ?>
                            <h2 class="sticky-mobile-logo"> <?php echo e($text_logo); ?> </h2>
                            <?php endif; ?>
                            <?php else: ?>
                            <!-- Main Header Logo -->
                            <?php if(isset($header_logo)): ?>
                            <img src="<?php echo e(project_asset($header_logo)); ?>" alt="Logo" class="img-fluid default-logo">
                            <?php elseif(isset($text_logo)): ?>
                            <h2 class="default-logo"> <?php echo e($text_logo); ?> </h2>
                            <?php endif; ?>
                            <!-- Main Header Mobile Logo -->
                            <?php if(isset($mobile_logo)): ?>
                            <img src="<?php echo e(project_asset($mobile_logo)); ?>" alt="Logo" class="img-fluid mobile-logo">
                            <?php elseif(isset($text_logo)): ?>
                            <h2 class="mobile-logo"> <?php echo e($text_logo); ?> </h2>
                            <?php endif; ?>
                            <!-- Sticky Header Logo -->
                            <?php if(isset($sticky_header_logo)): ?>
                            <img src="<?php echo e(project_asset($sticky_header_logo)); ?>" alt="Logo" class="img-fluid sticky-logo">
                            <?php elseif(isset($text_logo)): ?>
                            <h2 class="sticky-logo"> <?php echo e($text_logo); ?> </h2>
                            <?php endif; ?>
                            <!-- Sticky Header Mobile Logo -->
                            <?php if(isset($mobile_sticky_header_logo)): ?>
                            <img src="<?php echo e(project_asset($mobile_sticky_header_logo)); ?>" alt="Logo" class="img-fluid sticky-mobile-logo">
                            <?php elseif(isset($text_logo)): ?>
                            <h2 class="sticky-mobile-logo"> <?php echo e($text_logo); ?> </h2>
                            <?php endif; ?>
                            <?php endif; ?>
                    ...
                    <div class="mobile-menu-cover">
                        <ul class="nav mobile-nav-menu">
                            <li class="nav-menu-toggle">
                                <img src="<?php echo e(asset('themes/default/public/assets/images/menu-toggler.svg')); ?>" alt="" class="img-fluid svg">
                            </li>
                        </ul>
                    </div>
                    <!-- End of Mobile Menu -->
...
<!-- End of Header --><?php /**PATH /var/www/tl-commerce-saas/tlcommercesaas/themes/default/resources/views/frontend/layout/header.blade.php ENDPATH**/ ?>