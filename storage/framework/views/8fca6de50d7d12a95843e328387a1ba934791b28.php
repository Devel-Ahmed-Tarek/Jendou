<?php $__env->startSection('title'); ?>
    <?php echo e(translate('Manage Widgets')); ?>
        ...
        <div class="col-md-5" id="widget-section">
            <div class="card p-0">
                <a href="#allWidgets" class="px-4 py-3 card-body d-flex justify-content-between" data-toggle="collapse"
                    ...
                    <span class="black bold font-16"><?php echo e(translate('Available Widgets')); ?></span>
                                    ...
                                    <div class="col-sm-12 mb-2 widget">
                                        <div class="card card-body p-0">
                                            <div class="widget-info px-3 py-3 d-flex justify-content-between">
                                                <input type="hidden" name="id" value="<?php echo e($widget->id); ?>">
                                                <input type="hidden" name="sidebar_has_widget_id">
                                                <span class="black bold font-14"><?php echo e($widget->widget_name); ?></span>
                                                <div>
                                                    <span class="dropdown_icon widget-dropdown" onclick="dropDownIcon(this)"><i
                                                            class="icofont-arrow-right black bold d-inline-block font-14"></i></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <small class="col-12"><?php echo e($widget->widget_short_desc); ?></small>
                                </div>
                            </div>
        ...
        <div class="col-md-7 mt-3 mt-sm-0">
            <div class="row">
                ...
                <?php $__currentLoopData = $sidebars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sidebar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <div class="col-md-6 mb-2 mb-sm-5">
                        <div class="card p-0">
                            <a href="#<?php echo e($sidebar_attr_id); ?>" class="card-header d-flex justify-content-between"
                                data-toggle="collapse" aria-expanded="true" aria-controls="<?php echo e($sidebar_attr_id); ?>">
                                <span class="black bold font-16"><?php echo e($sidebar->sidebar_name); ?></span>
                                <span class="collapse_icon"><i
                                        class="icofont-arrow-right black bold font-16 d-inline-block collapse_arrow"></i></span>
                            </a>
                            <div class="collapse show mt-1 card-body sidebar-widget" id="<?php echo e($sidebar_attr_id); ?>">
                                <input type="hidden" name="sidebar_id" value="<?php echo e($sidebar->id); ?>">
                                <?php $__currentLoopData = $all_sidebar_widgets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $widget): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="mb-2 widget-item widget-border">
                                        <div class="card card-body p-0">
                                            <div class="widget-info px-3 py-3 d-flex justify-content-between">
                                                <input type="hidden" name="id" value="<?php echo e($widget->widget_id); ?>">
                                                <input type="hidden" name="sidebar_has_widget_id"
                                                    value="<?php echo e($widget->sidebar_has_widget_id); ?>">
                                                <span class="black bold font-14"><?php echo e($widget->widget_name); ?></span>
                                                <div>
                                                    <span class="dropdown_icon sidebar-dropdown"
                                                        onclick="dropDownIcon(this)"><i
                                                            class="icofont-arrow-right black bold d-inline-block font-14"></i></span>
                                                </div>
                                            </div>
                                        </div>
...
<?php $__env->startSection('custom_scripts'); ?>
    ...
    <!--End Editor-->
    <script src="<?php echo e(asset('/public/backend/assets/plugins/jquery-ui/jquery-ui.js')); ?>"></script>
    ...
    <script>
        ...
        //clicking on dropdown icon function
        function dropDownIcon(element) {
            if ($(element).hasClass('widget-dropdown')) {
                openDropMenu(element);
            } else {
                openSidebarDropMenu(element);
            }
        }
        ...
        function openDropMenu(element) {
            ...
            $.each(sidebars, function(index, value) {
                sidebar_list += '<li class="list-group-item black" onclick="selectForSidebar(this)" id="' + value +
                    '">' +
                    value +
                    '</li>';
            });
            ...
            let html = `
                    <div class="my-1 select-sidebar">
                        <ul class="list-group">` +
                sidebar_list +
                `</ul>
                        <div class="button-group row justify-content-around mt-2">
                            <button class="btn btn-danger sm" onclick="cancelDropmenu(this)"><?php echo e(translate('Cancel')); ?></button>
                            <button class="btn btn-primary sm" onclick="addWidget(this)"><?php echo e(translate('Add Widget')); ?></button>
                        </div>
                    </div>
                `;
        ...
        function addWidget(element) {
            ...
            sidebar_item = sidebar_item.replace(" ", "_");
            ...
            if (idMatch === true) {
                ...
                toastr.error("<?php echo e(translate('Adding Widget To Sidebar Failed')); ?>", "Error!");
            }
        ...
        function openSidebarDropMenu(element) {
            ...
            let sidebar_has_widget_id = $(element).parents(':eq(2)').find('input[name="sidebar_has_widget_id"]').val();
        ...
        function getSidebarHasWidgetField(sidebar_has_widget_id, widget_id, widget, lang = '') {
            $.ajax({
                type: "post",
                url: '<?php echo e(route('theme.tlcommerce.widget.get_input_field')); ?>',
                data: {
                    widget_id: widget_id,
                ...
                error: function(data, textStatus, jqXHR) {
                    toastr.error("<?php echo e(translate('Sidebar Widget Opening Failed')); ?>", "Error!");
                }
            });
        }
        ...
        function saveWidgetToSidebar(sidebar_attr_id, widget_id, element = null) {
            let sidebar_id = $('#' + sidebar_attr_id).find('input[name="sidebar_id"]').val();

            $.ajax({
                type: "post",
                url: '<?php echo e(route('theme.tlcommerce.widget.addToSidebar')); ?>',
                data: {
                ...
                success: function(res) {
                    if (res.error) {
                        toastr.error(res.error, "Error!");
                        $('#' + sidebar_attr_id).find('input[value="' + widget_id + '"]').parents(':eq(2)')
                            .remove();
                    } else {
                        $(element).find('input[name="sidebar_has_widget_id"]').val(res.sidebar_has_widget_id);
                        $('.sidebar-widget').sortable('refresh');
                ...
                error: function(data, textStatus, jqXHR) {
                    toastr.error("<?php echo e(translate('Widget Added To Sidebar Failed')); ?>", "Error!");
                }
            });
        }

        // remove widget from sidebar database
        function removeWidgeFromSidebar(sidebar_attr_id, sidebar_has_widget_id, element = null) {
            let sidebar_id = $('#' + sidebar_attr_id).find('input[name="sidebar_id"]').val();

            $.ajax({
                type: "post",
                url: '<?php echo e(route('theme.tlcommerce.widget.removeFromSidebar')); ?>',
                data: {
                    sidebar_id: sidebar_id,
                    sidebar_has_widget_id: sidebar_has_widget_id,
                },
        ...
        function saveWidgetsOrder(sidebar_attr_id) {
            ...
            $.ajax({
                type: "post",
                url: '<?php echo e(route('theme.tlcommerce.widget.saveWidgetOrder')); ?>',
                data: {
                    order: order,
                    sidebar_id: sidebar_id,
                },
        ...
        function widgetInputFormSubmit(element) {
            ...
            $.ajax({
                type: "post",
                url: '<?php echo e(route('theme.tlcommerce.widget.widgetSidebarForm')); ?>',
                data: {
                    data: formData,
                    sidebar_has_widget_id: sidebar_has_widget_id
                },
                ...
                error: function(data, textStatus, jqXHR) {
                    toastr.error("<?php echo e(translate('Widget Form Submit Failed Failed')); ?>", "Error!");
                }
            });
        }
        ...
        function authorSocialLink() {
            var url = '<?php echo e(route('theme.tlcommerce.options')); ?>';
...
<?php echo $__env->make('core::base.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tl-commerce-saas/tlcommercesaas/themes/tlcommerce/resources/views/backend/widgets/widget.blade.php ENDPATH**/ ?>