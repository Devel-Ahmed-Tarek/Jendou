...
return [
    ...
    */
    ...
    'providers'       => [
        ...
        //CoreSaas saas service providers
        // CoreSaas\Providers\RouteServiceProvider::class,
        // CoreSaas\Providers\CoreServiceProvider::class,

        App\Providers\PluginServiceProvider::class,
        App\Providers\PluginRouteServices::class,
        App\Providers\ThemeServiceProvider::class,
        App\Providers\ComposerServiceProvider::class,

        App\Providers\RouteServiceProvider::class,
        //Role Permissions Handeled
